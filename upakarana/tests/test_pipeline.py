...
@pytest.mark.xfail(strict=True, reason="sandhi grammar: 'has' promotion to shashthi-vibhakti in sandhi-viveka")
...
@pytest.mark.xfail(strict=True, reason="tense: 'was' promotion to bhuta-kaala in sandhi-viveka")
