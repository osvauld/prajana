...
let () =
  ...
  Yantra_parser.register_graph_op_arity "substr"           3;   (* substr string start length → string *)
  ...
  Yantra_parser.register_graph_op_arity "execute-chain"   2;  (* mantra-name args → value *)
  Yantra_parser.register_graph_op_arity "apply-op"        2;  (* op-name args → value *)
  Yantra_parser.register_graph_op_arity "square"          1;  (* x → x² *)
  Yantra_parser.register_graph_op_arity "half"            1;  (* x → x/2 *)
  Yantra_parser.register_graph_op_arity "double"          1;  (* x → x*2 *)
  Yantra_parser.register_graph_op_arity "word-node"       1;  (* word → node-name or VNone *)
  Yantra_parser.register_graph_op_arity "call-tantra"     2;  (* tantra-name [args] → value *)
  Yantra_parser.register_graph_op_arity "split-numeric"   1;  (* "5kg" → ["5.0", "kg"] *)
  Yantra_parser.register_graph_op_arity "raw-shabda"      2;  (* node-name key → own-only string *)
  Yantra_parser.register_graph_op_arity "node-layer"      1   (* node-name → "kosha"|"bhasha"|"sangati" *)
